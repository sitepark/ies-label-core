...
public final class UpsertLabelRequest {
  ...
  public boolean equals(Object o) {
    return (o instanceof UpsertLabelRequest that)
  ...
  public static final class Builder {
    ...
    private Builder(UpsertLabelRequest request) {
    ...
    public UpsertLabelRequest build() {
      ...
      return new UpsertLabelRequest(this);
    }
  }
}
